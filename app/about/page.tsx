    ...
    return (
        <div className="md:pt-24 pt-12 bg-gradient-to-b from-[#F0F5FD] to-10%-white">
            <div className="container">
                <div className="grid md:grid-cols-2 pb-[60px] md:py-[156px] border border-x-0 border-t-0 border-b-[#E0EAFF] md:gap-8 gap-5">
                    <h1 className='md:w-[544px]'>Company <span>Overview</span></h1>
                    <div className='md:w-[544px] text-[20px] md:text-2xl'>
                ...
                <div className='md:py-36 py-10 border border-x-0 border-t-0 border-b-[#E0EAFF]'>
                    <h1 className='md:mb-20 mb-10'>Our <span>Vision</span> and <span>Mission</span></h1>
                ...
                <div className='md:py-44 py-10 border border-x-0 border-t-0 border-b-[#E0EAFF]'>
                    <div className='grid md:grid-cols-2 md:gap-8 md:mb-[86px] gap-4 mb-[50px]'>
                        <h1 className='md:text-[52px] text-[40px]'><span>Meet the Experts</span> Behind Sanit Technologies</h1>
                        <div className='md:w-[544px] text-[20px] md:text-2xl text-[#748099]'>
                            <p className='md:mb-7 mb-4'>

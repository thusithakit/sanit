...
const zeroPad = (num:number) => String(num).padStart(2, '0')
  return (
    <div className={`flex flex-wrap mx-auto w-fit ${index % 2 === 0? 'lg:flex-row-reverse':''}`}>
      ...
      <div className={`max-w-[544px] flex flex-col justify-center ${index %2 === 0?'lg:pr-[55px]':'lg:pl-[55px]'}`}>
        <h1 className='text-[#92ABD6] opacity-30 lg:mb-6 mb-3'>{zeroPad(index)}</h1>
        <h2 className='lg:text-[40px] text-[30px] text-[#92ABD6] lg:mb-[25px] mb-[15px] leading-none'>{clientDetails.title}</h2>
        <p className='text-[#748099] lg:text-[18px] text-[16px] lg:mb-8 mb-2'>{clientDetails.description}</p>

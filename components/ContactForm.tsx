...
const ContactForm = () => {
    ...
    return (
        <form action={action}>
            <div className='grid grid-cols-2 gap-4 md:gap-y-8 gap-y-6'>
            ...
            <Textarea name="message" id="message" placeholder='Type your message' required className='inputs md:mb-12 mb-8 mt-6 md:mt-8 h-40' rows={40} />
            <div className='flex justify-between md:items-center gap-4 mb-4 flex-col items-start md:flex-row'>

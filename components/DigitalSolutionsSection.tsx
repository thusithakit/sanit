...
import { BsWifi, BsBezier, BsFillRouterFill, BsShieldShaded } from "react-icons/bs";
        ...
        <section className="bg-linear-to-t from-white from-50% to-[#F0F5FD] py-14 lg:py-[185px]">
            <div className="container">
                ...
                <div className="grid lg:grid-cols-2">
                    ...
                    <LearnMoreCard cardTitle="PABX Systems" cardContent="Our Private Automatic Branch Exchange (PABX) Systems help businesses enhance communication." href="/services/pabx-systems" className="border border-[#E0EAFF] border-x-0 lg:border-x lg:border-t-0 lg:border-r-0" icon={<BsBezier size={65} />} />

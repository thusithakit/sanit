        ...
        <section className="bg-linear-to-t from-white from-50% to-[#F0F5FD] py-14 lg:py-[185px]">
            <div className="container">
                ...
                <div className="grid lg:grid-cols-2">
                    <LearnMoreCard cardTitle="Network Solutions" cardContent="We offer end-to-end network infrastructure solutions to keep your business connected at all times." href="/services/network-solutions" className="border border-[#E0EAFF] border-x-0 lg:border-x lg:border-t-0 lg:border-l-0 hover:bg-[#4e5d80]" itemClass="group-hover:text-[#4e5d80]" icon={<BsWifi size={65} />} />
                    ...
                    <LearnMoreCard cardTitle="Firewall Solutions" cardContent="Protect your business from cyber threats with next-generation firewall security solutions." href="/services/firewall-solutions" className="border border-[#E0EAFF] border-x-0 lg:border-x lg:border-b-0 lg:border-r-0 hover:bg-[#4e5d80]" itemClass="group-hover:text-[#4e5d80]" icon={<BsShieldShaded size={65} />} />
                </div>
            </div>
        </section>
    )
